  ...
  return (
    <div>
      ...
      <div className="context">
        <Link className="context" to={"/"}>Vishal's Library</Link>
      </div>
      <div className="titleBar">
        <Link className="titleBarHeading" to={"/"}>Home</Link>
        <Link className="titleBarHeading" to={"/products"}>All Books</Link>
        <Link className="titleBarHeading" to={"/search"}>Search Books<FaSearch/></Link>
        <Link className="titleBarHeading" to={"/cart"}>Lib Cart <FaShoppingCart/></Link>
